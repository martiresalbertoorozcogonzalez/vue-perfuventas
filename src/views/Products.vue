    ...
    <div class="container">
      <div class="intro h-100">
        <div class="row h-100 justify-content-center align-items-center">
          ...
          <div class="col-md-6">
            <img src="/img/svg/products.svg" width="300" alt class="img-fluid" />
          </div>
        </div>
      </div>
      ...
      <div class="product-test">
        ...
        <button @click="addNew" class="btn btn-primary float-right btn-sm">Agregar producto</button>
